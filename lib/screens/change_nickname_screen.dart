...
class changeNick extends StatefulWidget {
  ...
  @override
  State<changeNick> createState() => _changeNickState();
}
...
class _changeNickState extends State<changeNick> {
  ...
  nicknameChange(data1, data2) async {
    Network network = Network();
    result = await network.changeNickname(data1, data2);
  }
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: OutlinedButton(
                              onPressed: () async {
                                await checkNickname(inputNickname);
                                ...
                                if (isNickname == false) {
                                  ...
                                  result = await nicknameChange(
                                      inputNickname, email);

                                  // 이메일 중복
                                  if (result == '0') {
                                    setState(() {
                                      nickWarning = '이미 가입된 닉네임입니다.';
                                    });
                                  } else {
